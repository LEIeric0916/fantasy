...
- `data/alliance-cards.json`：聯盟主牌（38 張，缺 2 張）
- `data/neutral-cards.json`：中立牌庫（目前先收錄教學用的「魔法知識」，可持續擴充）
...
- React UI 可選擇龍族、不朽者、機械、聯盟作為雙方陣營；聯盟嚴格使用 38 張主牌。
