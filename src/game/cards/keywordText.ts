...
export const KEYWORD_TEXT: Record<Keyword, KeywordText> = {
  ...
  WARD: { label: "光紋", description: "在場時不能被效果指定；不指定目標的範圍效果仍可影響它。" },
  DISCIPLINE: { label: "紀律", description: "在場時不受攻擊／生命改值、轉變、沉默、封印等干涉；仍會受到直接傷害。" },
  SANCTUARY: { label: "庇護", description: "在場時不能被效果直接消滅；仍可能因傷害或消失而離場。" },
